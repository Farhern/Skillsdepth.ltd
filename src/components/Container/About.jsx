      ...
      <div className='grid md:grid-cols-2 gap-8'>
        ...
        <div>
          <div>
            ...
            <span className='font-bold text-black'>Skillsedge</span> is a forward-thinking training institution dedicated to providing
            ...
            landscape. <span className='font-bold text-black'>Skillsedge</span> is dedicated to creating a positive impact by nurturing
