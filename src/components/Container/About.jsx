      ...
      <div className='grid md:grid-cols-2 gap-8'>
        ...
        <div>
          <div>
            ...
            <span className='font-bold text-black'>Skillsdepth</span> is a forward-thinking training institution dedicated to providing
            ...
            landscape. <span className='font-bold text-black'>Skillsdepth</span> is dedicated to creating a positive impact by nurturing
            ...
            <Link to="/aboutpage">
            <button className="py-3 px-6 text-sm border border-solid border-teal-500 mt-3 rounded-lg font-bold hover:bg-teal-500 duration-300 ease-in-out">
            Know More
            </button>
            </Link>
          </div>
