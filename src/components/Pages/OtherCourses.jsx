  ...
  return (
    ...
    <div className='section' id='aboutpage'>
      ...
      <p className="text-md text-gray-700 leading-7 max-w-[700px] mx-auto mt-2">
        ...
        The ultimate objective is to come up with the right worth of job based on the actual
      ...
      <p className="text-md text-gray-700 leading-7 max-w-[700px] mx-auto mt-2">
        ...
        the country's labour laws and that will provide all the safeguards against any legal
        claims as well as promote an environment conducive for staff productivity and
        performance.
      </p>
      <p className="text-md text-gray-700 leading-7 max-w-[700px] mx-auto mt-2">
      ...
      <div>
      <h1 className='text-center font-bold text-2xl mt-5'>TEAM EXPERTISE</h1>
        <p className="text-md text-gray-800 leading-7 max-w-[700px] mx-auto mt-2">
        Our team of experienced trainers and consultants brings a wealth of knowledge,
        expertise, and passion to every engagement. Our team members are recognized
        leaders in their respective fields, committed to providing exceptional service and
        achieving measurable results for our clients. Our team includes:
        </p>
      ...
      <div>
        <h1 className='text-center font-bold text-2xl mt-6'>METHODOLOGY</h1>
         <p className="text-md text-gray-800 leading-7 max-w-[700px] mx-auto mt-2">
         We take a customized and holistic approach to training and consultancy, tailoring our
         solutions to the specific needs and challenges of each client. Our methodology includes:
        </p>
        <ul  className='max-w-[700px] mx-auto list-disc'>
            <li>
